...
const DebateHistoryView: React.FC<DebateHistoryViewProps> = ({ debate, onBack }) => {
  ...
  return (
    <div className="flex flex-col h-[85vh] max-w-4xl mx-auto bg-slate-800 rounded-lg shadow-2xl animate-fade-in">
      ...
      <div className="p-4 bg-slate-800 border-b border-slate-700">
        <div className="flex items-center gap-3 bg-slate-900 p-3 rounded-lg">
            ...
            <div>
                ...
                <p className="text-sm text-slate-300 mt-1">{debate.judgement}</p>
            </div>
        </div>
      </div>
          ...
          <div key={msg.id} className="flex items-center gap-2">
            ...
            {msg.sender === 'ai' && (
              <button
                ...
                className="p-2 text-slate-400 hover:text-indigo-400 transition-colors rounded-full self-start"
